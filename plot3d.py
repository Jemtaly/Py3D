...
def main():
    ...
    xmin_scaler = tkinter.Scale(range_frame, from_ = -10.0, to = +10.0, resolution = 0.1, length = 180, variable = xmin_var, orient = tkinter.HORIZONTAL, label = 'X min')
    ymin_scaler = tkinter.Scale(range_frame, from_ = -10.0, to = +10.0, resolution = 0.1, length = 180, variable = ymin_var, orient = tkinter.HORIZONTAL, label = 'Y min')
    xmax_scaler = tkinter.Scale(range_frame, from_ = -10.0, to = +10.0, resolution = 0.1, length = 180, variable = xmax_var, orient = tkinter.HORIZONTAL, label = 'X max')
    ymax_scaler = tkinter.Scale(range_frame, from_ = -10.0, to = +10.0, resolution = 0.1, length = 180, variable = ymax_var, orient = tkinter.HORIZONTAL, label = 'Y max')
    xinr_scaler = tkinter.Scale(range_frame, from_ = 1, to = 100, length = 180, variable = xinr_var, orient = tkinter.HORIZONTAL, label = 'X intervals')
    yinr_scaler = tkinter.Scale(range_frame, from_ = 1, to = 100, length = 180, variable = yinr_var, orient = tkinter.HORIZONTAL, label = 'Y intervals')
    xmin_scaler.pack()
    ymin_scaler.pack()
    xmax_scaler.pack()
    ymax_scaler.pack()
    ...
    block = tkinter.Button(input_frame, text = 'Block Plot', command = lambda: plot(0))
